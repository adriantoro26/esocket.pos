...
module.exports = {
	...
	/**
	 * Converts given XML string into a JS object
	 * @param {String} dataXML
	 * @param {Object} options - Conversion options
	 * @returns XML in object format
	 */
	xmlToObject(dataXML, options = { compact: true, ignoreComment: true, spaces: 4 }){
		return xml2js(dataXML, options);
	}
};
